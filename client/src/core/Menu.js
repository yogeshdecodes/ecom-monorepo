    ...
    <div className="container">
        <div className="row row1 ">
            <ul className="largenav float-right">
                <li className="upper-links"><Link  style={activeTab(history, '/')} className="links" to="/">
            Home
          </Link></li>
        ...
        <div className="row row2">
            ...
            <div className="flipkart-navbar-search smallsearch col-sm-8 col-11">
                <div className="row">
                    <input className="flipkart-navbar-input col-11" type="" placeholder="Search for Products, Brands and more" name=""/>
            ...
            <div className="cart largenav col-sm-2">
                <Link style={activeTab(history, '/cart')} className="cart-button" to="/cart">
